...
public class BlogRepository : IBlogRepository
{
    ...
    public Task<IList<Author>> GetAuthorsAsync(CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<Post> GetPostByIdAsync(int id, bool includeDetails = false, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<bool> IsPostSlugExistedAsync(int id, string slug, CancellationToken cancellationToken = default)
    {
        throw new NotImplementedException();
    }
}
